...
- Friendly and approachable tone`,
...

  {
    ...
    notes: 'URGENT: Conference Book ad artwork due June 1 — full color, 8 1/16" × 10 1/2". Frankie Allen is accepting artwork ahead of sponsorship check clearing.\n\nSponsor perks: signage outside Exhibit Hall, named in Conference Book as Coffee Break Sponsor, recognized at Opening General Session.\n\nExhibit Hall sold out — WELS spot reserved. DEL is presenting a workshop on the WELS 4-Cycle Direct Entry system at this conference. 39th annual conference.',
    ...
    assets: [
      ...
      },
      {
        ...
        previewColor: 'bg-sky-300', aspectRatio: '8/10', status: 'pending',
        notes: 'Full color. Size: 8 1/16" × 10 1/2". DEADLINE June 1, 2026. Send artwork to Frankie Allen (frankieallen_2000@yahoo.com). WELS + Zipdata branding.',
